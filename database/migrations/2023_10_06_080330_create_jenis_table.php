...
class CreateJenisTable extends Migration
{
    ...
    public function up()
    {
        Schema::create('tbmjen', function (Blueprint $table) {
            $table->id('jenid')->autoIncrement();
            $table->foreignId('kelid');
            $table->string('jenkode');
            $table->string('jennama');
            $table->string('dasarhukum')->nullable();
