...
class CreateHistoryPengajuanGajisTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbhistorypengajuangaji', function (Blueprint $table) {
            $table->id('historypengajuangajiid');
            $table->foreignId('pegawaipengajuangajiid');
    ...
    {
        Schema::dropIfExists('history_pengajuan_gajis');
    }
}
