...
class CreateSarprasTersediasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbmsarprastersedia', function (Blueprint $table) {
            $table->id('sarprastersediaid')->autoIncrement();
    ...
    {
        Schema::dropIfExists('tbmsarprastersedia');
    }
}
