...
class CreateDetailSarprasTersediasTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('tbtransdetailsarpras', function (Blueprint $table) {
            $table->id('detailsarprasid')->autoIncrement();
    ...
    {
        Schema::dropIfExists('tbtransdetailsarpras');
    }
}
