                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <div class="col-md-12">
                                <textarea id="analisakebsarpras" class="form-control @error('analisakebsarpras') is-invalid @enderror" name="analisakebsarpras" autocomplete="name" required>{{ $sarpraskebutuhan->analisakebsarpras }}</textarea>
