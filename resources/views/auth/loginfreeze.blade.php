...
<div class="card" style="height: 550px; background-color: transparent;">
    <div class="row">
        <div class="col-lg-8 col-md-8 border-left hero-image" style="height: 550px; background-color: transparent;">
            <div class="card-body">
            </div>
        </div>
        <div class="col-lg-4 col-md-4" style="height: 550px; background-color: rgba(255, 255, 255, 0.6);">
