...
<div class="login-box card" id="login-box">
    <div class="card-body">
        ...
        <form class="form-horizontal form-material" id="loginform" method="POST" action="{{ route('login') }}">
            @csrf
            <h3 class="box-title m-t-0 m-b-0">Login</h3><small>Masukkan username dan password yang valid untuk dapat mengakses sistem ini</small>
...
<div class="login-box card card-footer text-white" id="login-footer">
    <div class="card-body">
