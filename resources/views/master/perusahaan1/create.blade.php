        ...
        <h5 class="card-title text-uppercase">TAMBAH DATA</h5><hr />
            ...
            <form method="POST" action="{{ route('perusahaan.store') }}" class="form-horizontal form-material m-t-40 needs-validation" enctype="multipart/form-data" id="formPerusahaan">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="kodedaftar" type="text" class="form-control @error('kodedaftar') is-invalid @enderror" name="kodedaftar" value="{{ old('kodedaftar') }}" required autocomplete="name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <select id="badanusaha" class="custom-select form-control @error('badanusaha') is-invalid @enderror" name='badanusaha' required autofocus>
                            ...
                            <option @if (old("badanusaha")==enum::BADANUSAHA_PERUSAHAAN_PERSEORANGAN) selected @endif value="{{enum::BADANUSAHA_PERUSAHAAN_PERSEORANGAN}}">{{ 'Perusahaan Perseorangan' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_FIRMA) selected @endif value="{{enum::BADANUSAHA_FIRMA}}">{{ 'Firma' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_CV) selected @endif value="{{enum::BADANUSAHA_CV}}">{{ 'CV' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_PT) selected @endif value="{{enum::BADANUSAHA_PT}}">{{ 'PT' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_PERSERO) selected @endif value="{{enum::BADANUSAHA_PERSERO}}">{{ 'Persero' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_BUMD) selected @endif value="{{enum::BADANUSAHA_BUMD}}">{{ 'BUMD' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_BUMN) selected @endif value="{{enum::BADANUSAHA_BUMN}}">{{ 'BUMN' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_KOPERASI) selected @endif value="{{enum::BADANUSAHA_KOPERASI}}">{{ 'Koperasi' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_YAYASAN) selected @endif value="{{enum::BADANUSAHA_YAYASAN}}">{{ 'Yayasan' }}</option>
                            <option @if (old("badanusaha")==enum::BADANUSAHA_LAINNYA) selected @endif value="{{enum::BADANUSAHA_LAINNYA}}">{{ 'Lainnya' }}</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <select id="status" class="custom-select form-control @error('status') is-invalid @enderror" name='status' required autofocus>
                            ...
                            <option value="{{enum::STATUS_BADANUSAHA_PUSAT}}" @if (old("status")==enum::STATUS_BADANUSAHA_PUSAT) selected @endif>{{ 'Pusat' }}</option>
                            <option value="{{enum::STATUS_BADANUSAHA_CABANG}}" @if (old("status")==enum::STATUS_BADANUSAHA_CABANG) selected @endif>{{ 'Cabang' }}</option>
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <select id="kawasanid" class="custom-select form-control @error('kawasanid') is-invalid @enderror" name='kawasanid' autofocus>
                            ...
                            <option data-provid="{{$item->provid}}" data-kotaid="{{$item->kotaid}}" data-kecamatanid="{{$item->kecamatanid}}" data-kelurahanid="{{$item->kelurahanid}}" value="{{$item->kawasanid}}" @if (old("kawasanid")==$item->kawasanid) selected @endif>{{ $item->namainstansi }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <select id="kotaid" class="custom-select form-control @error('kotaid') is-invalid @enderror" name='kotaid' required autofocus>
                            ...
                            <option value="{{$item->kotaid}}" @if (!is_null($instansi) && $instansi->kota == $item->kotaid) selected @endif>{{ $item->kodekota . ' ' . $item->namakota }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email') }}" autocomplete="name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="website" type="text" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website') }}" autocomplete="name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="telp" type="text" class="form-control @error('telp') is-invalid @enderror" name="telp" value="{{ old('telp') }}" required autocomplete="name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="nib" type="text" class="form-control @error('nib') is-invalid @enderror" name="nib" value="{{ old('nib') }}" required autocomplete="name">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <select id="bidangusahaid" class="custom-select form-control @error('bidangusahaid') is-invalid @enderror" name='bidangusahaid' required autofocus>
                            ...
                            <option value="{{$item->bidangusahaid}}" data-kode="{{$item->kode}}" @if (old("bidangusahaid")==$item->bidangusahaid) selected @endif>{{ $item->bidangusaha }}</option>
                            @endforeach
                        </select>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="kbli" type="text" class="form-control @error('kbli') is-invalid @enderror" name="kbli" value="{{ old('kbli') }}" required autocomplete="name">
...
<script>
    var kotaid = '{{ old("kotaid", (!is_null($instansi) ? $instansi->kota : "")) }}';
