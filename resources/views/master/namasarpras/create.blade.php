...
<div class="card">
    <div class="card-body p-4">
        <h5 class="card-title text-uppercase">TAMBAH DATA</h5><hr />
            ...
            <form method="POST" action="{{ route('namasarpras.store') }}" class="form-horizontal form-material m-t-40 needs-validation" enctype="multipart/form-data">
                @csrf
                ...
                <div class="form-group row">
                    ...
                    <div class="col-md-12">
                        <input id="namasarpras" type="text" class="form-control @error('namasarpras') is-invalid @enderror" name="namasarpras" value="" maxlength="100" required autocomplete="namasarpras" autofocus>
