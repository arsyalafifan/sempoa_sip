...
<div class="card">
    <div class="card-body p-4">
        <h5 class="card-title text-uppercase">DAFTAR MANPOWER</h5><hr />
            ...
            buttons: {
                buttons: [{
                    ...
                    action: function () {
                        ...
                        url = url.replace(':id', id);
                        var kode = manpowertable.rows({
                            selected: true
                        }).data()[0]['nokelas'];
                        var nama = manpowertable.rows({
                            selected: true
                        }).data()[0]['namakelas'];
                        swal.fire({
