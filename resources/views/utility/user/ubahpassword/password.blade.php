        ...
        <div class="card p-4">
            <div class="card-body">
                <center class="m-t-30"> <img src="{{ asset('/1.jpg') }}" class="img-circle" width="150" />
                    ...
                    @elseif ($user->akses->grup === Config::get('constants.grup.grup_dinas'))
                    <h6 class="card-subtitle">Level : {{ Config::get('constants.grupnama.grupnama_dinas') }}</h6>
                    @elseif ($user->akses->grup === Config::get('constants.grup.grup_sekolah'))
                    <h6 class="card-subtitle">Level : {{ Config::get('constants.grupnama.grupnama_sekolah') }}</h6>
                    @endif
            ...
            <div class="tab-content">
                <div class="tab-pane active" id="home" role="tabpanel">
                    <div class="card-body">
                        ...
                        <form id="user-form" class="form-horizontal form-material" method="POST" action="{{ route('user.password.save') }}">
                        @csrf
