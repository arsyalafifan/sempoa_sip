                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('kodemurid') is-invalid @enderror" id="kodemurid" name="kodemurid"
                            value="{{ old('kodemurid') }}" autofocus required>
                        @error('kodemurid')
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('namamurid') is-invalid @enderror" id="namamurid"
                            name="namamurid" value="{{ old('namamurid') }}" autofocus required>
                        @error('namamurid')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <select id="jeniskelamin" class="col-md-12 custom-select form-control" name="jeniskelamin" autofocus
                            ...
                            <option value="{{ $id }}"> {{ enum::listJenisKelamin('desc')[$loop->index] }}</option>
                            @endforeach
                        </select>
                    </div>
                </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('alamat') is-invalid @enderror" id="alamat"
                            name="alamat" value="{{ old('alamat') }}" autofocus required>
                        @error('alamat')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('tempatlahir') is-invalid @enderror"
                            id="tempatlahir" name="tempatlahir" value="{{ old('tempatlahir') }}" autofocus>
                        @error('tempatlahir')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('notelp') is-invalid @enderror"
                            id="notelp" name="notelp" value="{{ old('notelp') }}" autofocus>
                        @error('notelp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('namasekolah') is-invalid @enderror"
                            id="namasekolah" name="namasekolah" value="{{ old('namasekolah') }}" autofocus>
                        @error('namasekolah')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('namaortu') is-invalid @enderror" id="namaortu"
                            name="namaortu" value="{{ old('namaortu') }}" autofocus>
                        @error('namaortu')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('emailortu') is-invalid @enderror" id="emailortu"
                            name="emailortu" value="{{ old('emailortu') }}" autofocus>
                        @error('emailortu')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
