                ...
                <div class="modal-body">
                    <div class="card-body">
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select id="modalupahlevel" class="custom-select-upah form-control" name='modalupahlevel' required>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-9">
                                <select id="modalupahgolid" class="custom-select-upah form-control" name='modalupahgolid'>
            ...
            <div class="modal-body">
                <div class="card-body">
                    <div class="form-group row">
                        ...
                        <div class="col-lg-12">
                            <b>Unduh format excel: </b><a href="{{ route('profilperusahaan.downloadformatexcel') }}">Download</a><br>
                            <b>Unduh Daftar Kec dan Kel Kota Batam: </b><a href="{{ route('profilperusahaan.downloaddaftarkecamatan') }}">Download</a>
                        </div>
                        <div class="col-lg-12">
...
<div class="row">
    <div class="col-12">
        <div class="card">
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card-body">
                        <div class="row">
                             <div class="col-md-3">
                            <label for="filterperusahaanid" class="col-md-12 col-form-label text-md-left">{{ __('Perusahaan') }}</label>
                        </div>
                        <div class="col-md-9">
                            <select id="filterperusahaanid" class="col-md-12 custom-select form-control" name='filterperusahaanid' autofocus>
                                <option value="">-- Pilih Perusahaan --</option>
                                @foreach ($perusahaanlist as $item)
                                    <option value="{{$item->perusahaanid}}" @if (old("perusahaanid", (!is_null($perusahaan) ? $perusahaan->perusahaanid : ''))==$item->perusahaanid) selected @endif>{{ $item->kodedaftar.' '.$item->nama }}</option>
                                @endforeach
                            </select>
                        </div>
                        </div>
            ...
            <hr>
            @endif
            <form method="POST" action="{{ route('profilperusahaan.save') }}" class="form-horizontal form-material m-t-40 needs-validation" enctype="multipart/form-data" id="formPerusahaan" onsubmit="return validate();">
            @csrf
                @if(!Auth::user()->isSuperadmin())
                <div class="row mb-0 text-md-right">
                    <div class="col-md-12">
                        <button type="button" onclick="addData();" class="btn btn-info btn-sm waves-effect waves-light mr-5">{{ __('Import Data') }}</button>
                    </div>
                </div>
                @endif
                <div class="row">
                    <div class="col-lg-3 col-md-4">
                        <div class="card-body inbox-panel">
                            <div class="list-group">
                                <u><h5 class="card-title text-uppercase">LOGO</h5></u>
                                <div class="form-group">
                                    <div class="row d-flex justify-content-center">
                                        <img id="imglogo" class="col-md-12 img-fluid img-thumbnail rounded" src="{{ old('logofile', (!is_null($perusahaan) && isset($perusahaan->logo) ? 'images/'.$perusahaan->logo : '')) }}" alt="Logo Perusahaan" />
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="row">
                    ...
                    <div class="col-lg-9 col-md-8 border-left">
                        <div class="card-body">
                            <h5 class="card-title text-uppercase">PROFIL PERUSAHAAN</h5><hr />
                                @if (count($errors) > 0)
                                ...
                                <input type="hidden" name="perusahaanid" id="perusahaanid" value="{{ old('perusahaanid', (!is_null($perusahaan) ? $perusahaan->perusahaanid : '')) }}">
                                <input type="hidden" name="logofile" id="logofile" value="{{ old('logofile', (!is_null($perusahaan) ? 'images/'.$perusahaan->logo : '')) }}">
                                ...
                                <div class="tab-content" id="perusahaanTabContent">
                                    <div class="tab-pane fade show active" id="perusahaandataumum" role="tabpanel" aria-labelledby="perusahaandataumum-tab">
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="kodedaftar" type="text" class="form-control @error('kodedaftar') is-invalid @enderror" name="kodedaftar" value="{{ old('kodedaftar', (!is_null($perusahaan) ? $perusahaan->kodedaftar : '')) }}" autocomplete="name" readonly>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <select id="badanusaha" class="custom-select form-control @error('badanusaha') is-invalid @enderror" name='badanusaha' required autofocus>
                                                    ...
                                                    <option @if (old("badanusaha", (!is_null($perusahaan) ? $perusahaan->badanusaha : ''))==$item['badanusaha']) selected @endif value="{{$item['badanusaha']}}">{{ $item['badanusahavw'] }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="nama" type="text" class="form-control @error('nama') is-invalid @enderror" name="nama" value="{{ old('nama', (!is_null($perusahaan) ? $perusahaan->nama : '')) }}" autocomplete="name" readonly>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <select id="status" class="custom-select form-control @error('status') is-invalid @enderror" name='status' autofocus disabled>
                                                    <option value="">-- Pilih Status --</option>
                                                    <option value="{{enum::STATUS_BADANUSAHA_PUSAT}}" @if (old("status", (!is_null($perusahaan) ? $perusahaan->status : ''))==enum::STATUS_BADANUSAHA_PUSAT) selected @endif>{{ 'Pusat' }}</option>
                                                    <option value="{{enum::STATUS_BADANUSAHA_CABANG}}" @if (old("status", (!is_null($perusahaan) ? $perusahaan->status : ''))==enum::STATUS_BADANUSAHA_CABANG) selected @endif>{{ 'Cabang' }}</option>
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <select id="kawasanid" class="custom-select form-control @error('kawasanid') is-invalid @enderror" name='kawasanid' autofocus>
                                                    ...
                                                    <option data-provid="{{$item->provid}}" data-kotaid="{{$item->kotaid}}" data-kecamatanid="{{$item->kecamatanid}}" data-kelurahanid="{{$item->kelurahanid}}" value="{{$item->kawasanid}}" @if (old("kawasanid", (!is_null($perusahaan) ? $perusahaan->kawasanid : ''))==$item->kawasanid) selected @endif>{{ $item->namainstansi }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <textarea id="alamat" class="form-control @error('alamat') is-invalid @enderror" name="alamat" required autocomplete="name">{{ old('alamat', (!is_null($perusahaan) ? $perusahaan->alamat : '')) }}</textarea>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <select id="provinsiid" class="custom-select form-control @error('provinsiid') is-invalid @enderror" name='provinsiid' autofocus disabled>
                                                    <option value="">-- Pilih Provinsi --</option>
                                                    @foreach ($prov as $item)
                                                    <option value="{{$item->provid}}" @if (old('provinsiid', (!is_null($perusahaan) ? $perusahaan->provinsiid : '')) == $item->provid) selected @endif>{{ $item->kodeprov . ' ' . $item->namaprov }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <select id="kotaid" class="custom-select form-control @error('kotaid') is-invalid @enderror" name='kotaid' autofocus disabled>
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{ old('email', (!is_null($perusahaan) ? $perusahaan->email : '')) }}" autocomplete="name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="website" type="text" class="form-control @error('website') is-invalid @enderror" name="website" value="{{ old('website', (!is_null($perusahaan) ? $perusahaan->website : '')) }}" autocomplete="name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="telp" type="text" class="form-control @error('telp') is-invalid @enderror" name="telp" value="{{ old('telp', (!is_null($perusahaan) ? $perusahaan->telp : '')) }}" required autocomplete="name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="npwp" type="text" class="form-control @error('npwp') is-invalid @enderror" name="npwp" value="{{ old('npwp', (!is_null($perusahaan) ? $perusahaan->npwp : '')) }}" required autocomplete="name">
                                        ...
                                        <div class="form-group row">
                                            ...
                                            <div class="col-md-12">
                                                <input id="nib" type="text" class="form-control @error('nib') is-invalid @enderror" name="nib" value="{{ old('nib', (!is_null($perusahaan) ? $perusahaan->nib : '')) }}" autocomplete="name" readonly>
                                                ...
                                                @foreach ($waktukerjanormal as $col)
                                                    <div class="col">
                                                        ...
                                                        <div class="custom-control custom-switch mb-2" dir="ltr">
                                                            <input type="checkbox" class="form-control custom-control-input chk-perusahaanwaktukerja" id="perusahaanwaktukerja{{$item->waktukerjaid}}" name="perusahaanwaktukerja[{{$item->waktukerjaid}}]" value="1"  
                                                            @if (
                                                                array_key_exists(
                                                                    $item->waktukerjaid,
                                                                    old(
                                                    ...
                                                    <div class="col">
                                                        ...
                                                        <div class="custom-control custom-switch mb-2" dir="ltr">
                                                            ...
                                                            <div class="custom-control custom-switch mt-2" dir="ltr">
                                                                <input type="checkbox" class="form-control custom-control-input chk-perusahaansubfasilitas subperusahaanfasilitas{{$item->fasilitasid}}" id="perusahaansubfasilitas{{$subitem->subfasilitasid}}" name="perusahaansubfasilitas[{{$subitem->subfasilitasid}}]" value="1" 
                                                                @if (
                                                                    array_key_exists(
...
<script>
    var kotaid = '{{ old("kotaid", (!is_null($perusahaan) ? $perusahaan->kotaid : '')) }}';
    var kecamatanid = '{{ old("kecamatanid", (!is_null($perusahaan) ? $perusahaan->kecamatanid : '')) }}';
    var kelurahanid = '{{ old("kelurahanid", (!is_null($perusahaan) ? $perusahaan->kelurahanid : '')) }}';

    @php $listperusahaankbli = old('perusahaankbli', (!is_null($perusahaan) ? $perusahaan->perusahaankbli : [])); @endphp
    ...
    @php $listupah = old('upah', (!is_null($perusahaan) ? $perusahaan->upah : [])); @endphp
    ...
    var row_number_kbli = {{ 
        (
            null!==(old('perusahaankbli')) && count(old('perusahaankbli')) > 0 ?  (count(old('perusahaankbli'))+1) 
                : (!is_null($perusahaan) && count($perusahaan->perusahaankbli) > 0 ? (count($perusahaan->perusahaankbli)+1) : 1)
        ) 
    }} ;
    ...
    var row_number_upah = {{ 
        (
            null!==(old('upah')) && count(old('upah')) > 0 ?  (count(old('upah'))+1) 
                : (!is_null($perusahaan) && count($perusahaan->upah) > 0 ? (count($perusahaan->upah)+1) : 1)
        ) 
    }} ;
    ...
    $(document).ready(function() {
        ...
        $('#formPerusahaan').on('submit', function() {
            // $('#badanusaha').prop('disabled', false);
        ...
        $('#filterperusahaanid').change( function() { 
            if($(this).val()!=""){
                resetForm();
                var url = "{{ route('profilperusahaan.index') }}";   
                ...
                $.ajax({
                    ...
                    success:function(data) {
                        if(data.success){
                            let dataPerusahaan = data.data.perusahaan;
                            $('#perusahaanid').val(dataPerusahaan.perusahaanid);
                            $('#logofile').val((dataPerusahaan.logo == null ? '' : 'images/'+dataPerusahaan.logo));
                            $('#kodedaftar').val(dataPerusahaan.kodedaftar);
                            $('#nama').val(dataPerusahaan.nama);
                            $('#alamat').val(dataPerusahaan.alamat);
                            $('#email').val(dataPerusahaan.email);
                            $('#website').val(dataPerusahaan.website);
                            $('#telp').val(dataPerusahaan.telp);
                            $('#npwp').val(dataPerusahaan.npwp);
                            $('#nib').val(dataPerusahaan.nib);

                            //Without Triggerring Change
                            $("#badanusaha").val(dataPerusahaan.badanusaha).trigger('change.select2');
                            $("#status").val(dataPerusahaan.status).trigger('change.select2');
                            $("#kawasanid").val(dataPerusahaan.kawasanid).trigger('change.select2');

                            kotaid = dataPerusahaan.kotaid;
                            kecamatanid = dataPerusahaan.kecamatanid;
                            kelurahanid = dataPerusahaan.kelurahanid;

                            $('#provinsiid').select2();
                            $('#provinsiid').val(dataPerusahaan.provinsiid);
                            $('#provinsiid').trigger('change');

                            $('#imglogo').attr('src', (dataPerusahaan.logo!=null ? 'images/'+dataPerusahaan.logo : ""));

                            v_listDataKbli = dataPerusahaan.perusahaankbli.map((perusahaankbli, index) => ({
                                indexperusahaankbli: index,
                                perusahaankbliid: (typeof perusahaankbli.perusahaankbliid !== 'undefined' ? perusahaankbli.perusahaankbliid : ''),
                                bidangusahaid: perusahaankbli.bidangusahaid,
                                kbli: perusahaankbli.kbli,
                                bidangusahanama: (perusahaankbli.bidangusaha ? (perusahaankbli.bidangusaha.bidangparent ? perusahaankbli.bidangusaha.bidangparent.kode : '')+perusahaankbli.bidangusaha.kode+' '+perusahaankbli.bidangusaha.bidangusaha : '')
                            }));

                            loadDataKbli();

                            dataPerusahaan.perusahaanwaktukerja.forEach((perusahaanwaktukerja) => {
                                $("#perusahaanwaktukerja"+perusahaanwaktukerja.waktukerjaid).prop('checked', true);
                            });

                            dataPerusahaan.perusahaanfasilitas.forEach((perusahaanfasilitas) => {
                                $("#perusahaanfasilitas"+perusahaanfasilitas.fasilitasid).prop('checked', true);
                            });

                            $(".chk-perusahaanfasilitas").trigger("change");

                            dataPerusahaan.perusahaansubfasilitas.forEach((perusahaansubfasilitas) => {
                                $("#perusahaansubfasilitas"+perusahaansubfasilitas.subfasilitasid).prop('checked', true);
                            });

                            v_listDataUpah = dataPerusahaan.upah.map((upah, index) => ({
                                indexupah : index,
                                upahid: (typeof upah.upahid !== 'undefined' ? upah.upahid : ''),
                                level: upah.level,
                                golid: upah.golid,
                                ket: upah.ket,
                                upahmin: upah.upahmin,
                                golnama: upah.gol ? (upah.gol.subgolpokok ? (upah.gol.subgolpokok.golpokok ? upah.gol.subgolpokok.golpokok.nama+' - ' : '') : '')+upah.gol.nama : '' , 
                                levelnama: upah.levelnama
                            }));
                    ...
                    error: function(jqXhr, json, errorThrown){
                        if (jqXhr.status==404){
                            swal("Profil Perusahaan", "Data Perusahaan tidak ditemukan", "error");
                        }else{
                            swal("Profil Perusahaan", "Gagal Mendapatkan data", "error");
                        }
                        $(".loadingdata").hide();
                    }
                });
        ...
        function resetForm(){
            ...
            //Without Triggerring Change
            $("#badanusaha").val("").trigger('change.select2');
            $("#status").val("").trigger('change.select2');
            $("#kawasanid").val("").trigger('change.select2');
            ...
            $(".chk-perusahaanwaktukerja").each(function(){
                $(this).prop("checked", false);
            });

            $(".chk-perusahaanfasilitas").each(function(){
                $(this).prop("checked", false);
            });

            $(".chk-perusahaansubfasilitas").each(function(){
                $(this).prop("checked", false);
            });
    ...
    function confirmImport(){
        ...
        swal({   
            title: "Warning !",   
            text: "Data Perusahaan yang sudah ada di database akan diupdate, Lanjutkan ?",   
            type: "warning",   
            showCancelButton: true,   
            confirmButtonColor: "#DD6B55",   
            confirmButtonText: "Ya, lanjutkan!",   
    ...
    function importExcel(){
        ...
        $.ajax({
            ...
            url: "{{ route('profilperusahaan.importexcel') }}", 
            dataType: 'text',  
            cache: false,
            contentType: false,
            processData: false,
