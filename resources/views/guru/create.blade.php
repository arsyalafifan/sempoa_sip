                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('kodeguru') is-invalid @enderror" id="kodeguru" name="kodeguru"
                            value="{{ old('kodeguru') }}" autofocus required>
                        @error('kodeguru')
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('namaguru') is-invalid @enderror" id="namaguru"
                            name="namaguru" value="{{ old('namaguru') }}" autofocus required>
                        @error('namaguru')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('namapanggilan') is-invalid @enderror" id="namapanggilan"
                            name="namapanggilan" value="{{ old('namapanggilan') }}" autofocus required>
                        @error('namapanggilan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('notelp') is-invalid @enderror" id="notelp"
                            name="notelp" value="{{ old('notelp') }}" autofocus>
                        @error('notelp')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
                ...
                <div class="col-md-4">
                    <div class="form-group row">
                        ...
                        <input type="text" class="form-control @error('pendidikan') is-invalid @enderror" id="pendidikan"
                            name="pendidikan" value="{{ old('pendidikan') }}" autofocus>
                        @error('pendidikan')
                        <div class="invalid-feedback">
                            {{ $message }}
                        </div>
